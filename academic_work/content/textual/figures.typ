...
#describe_figure(
  [
    #figure(
      caption: [#lorem(12)],
      block(height: 5cm, width: 5cm, fill: red),
    )<example_figure_of_red_rectangle_of_5cm_width_and_5cm_height>
  ],
)

Este é um exemplo de figura com largura de 100% e altura de 5cm: @example_figure_of_red_rectangle_of_100percent_width_and_5cm_height.
#lorem(50)
...
#describe_figure(
  [
    ...
    )<example_figure_of_red_rectangle_of_100percent_width_and_5cm_height>
  ],
)
...
Este é um exemplo de figura composta de dois retângulos vermelhos com largura de 100% e altura de 5cm, com uma fonte de autoria e nota: @example_figure_of_two_red_rectangles_of_100percent_width_and_5cm_height_each_with_source_and_note.
#lorem(50)
...
#describe_figure(
  ...
  [
    ...
    )<example_figure_of_two_red_rectangles_of_100percent_width_and_5cm_height_each_with_source_and_note>
  ],
)
...
#describe_figure(
  ...
  subpar.grid(
    ...
    grid.cell()[
      #figure(image("../../assets/images/black_square.png", width: 5cm), caption: [
        #lorem(5)
      ])<first_sub_figure>
    ],
